...
## Avocat futur associé, droit du dommage corporel
### Victimes & Préjudices Avocats, Grenoble

Nom du candidat : ______________________________________
...
Consacrez les 5 à 10 premières minutes aux présentations. Présentez votre rôle et votre parcours, puis le déroulé du processus et ce qui se passera après cet entretien. Demandez au candidat s'il a des questions avant de commencer.

Ouvrez avec l'une de ces questions.

1. Selon vous, en quoi consiste ce poste ?
2. Qu'est-ce qui vous a fait répondre ?
3. Au vu de ce que vous savez du poste, de quoi auriez-vous besoin pour y réussir ?
...
Prenez des notes pendant l'entretien, pas après. Notez ce que le candidat dit, pas votre interprétation. La note vient ensuite.

## Règles après l'entretien
...
Notez seul, avant d'en parler à l'autre intervieweur. Une note influencée ne vaut rien.

## Bonnes pratiques

Ouvrez par quelques minutes de conversation légère et générale pour détendre l'échange.

Adaptez votre vocabulaire à l'expérience de la personne.

Posez autant de questions d'approfondissement que nécessaire. Une question comportementale sans approfondissement produit un récit préparé. C'est l'approfondissement qui produit le signal.

Cherchez le comportement, pas l'opinion. Si le candidat répond « en général, je fais... », ramenez-le à un fait : « donnez-moi une situation précise ».

Restez attentif aux biais. Vous avez tendance à mieux noter les personnes qui démontrent une compétence de la même façon que vous. Vous excluez alors des personnes qui communiquent, travaillent ou décident autrement, sans être moins compétentes.

Pour situer un candidat sur une compétence, servez-vous des trois colonnes de comportements. Si la réponse fait apparaître au moins deux comportements de la colonne « doué », la note est 4.
...
# 3. Grille de synthèse

## Système de notation

**4, dépasse les critères.** Le candidat a montré des connaissances, des compétences ou des capacités qui dépassent les critères définis pour le poste.

**3, répond aux critères.** Le candidat a montré des connaissances, des compétences ou des capacités qui répondent entièrement aux critères définis pour le poste.

**2, répond partiellement aux critères.** Le candidat a montré des connaissances, des compétences ou des capacités qui répondent en partie mais non en totalité aux critères définis pour le poste.

**1, ne répond pas aux critères.** Le candidat a montré des connaissances, des compétences ou des capacités clairement en dessous des critères définis pour le poste.
...
Une note de 2 sur Gérer la complexité ou sur Être résilient se discute si le reste est solide, et se traite par un plan d'accompagnement écrit.

## Recommandation de l'intervieweur
...
**Minutes 0 à 5. Vous présentez le cabinet et le poste.**

Trois phrases sur le cabinet, exclusivement du côté des victimes. Une phrase sur la raison du recrutement, l'association. Une phrase sur le déroulé du processus, quatre étapes, entretiens 3 et 4 le même jour.

**Minutes 5 à 20. Vous qualifiez.**

| Point à vérifier | Question | Réponse |
|---|---|---|
| Situation actuelle | Où exercez-vous aujourd'hui, sous quel statut, et depuis quand ? | |
| Pratique réelle | Quelle est la part du dommage corporel dans votre activité ? En volume, pas en intérêt | |
| Contentieux | Combien de fois avez-vous plaidé au cours des douze derniers mois ? | |
...
| Statut souhaité | Collaboration libérale ou salariat, avez-vous une préférence et pourquoi ? | |
| Mobilité | Où vivez-vous, et qu'implique concrètement une installation à Grenoble ? | |
| Disponibilité | Quel est votre préavis ? À partir de quand seriez-vous disponible ? | |
| Rémunération | Où vous situez-vous aujourd'hui, et qu'attendez-vous ? | |
| Autres processus | Êtes-vous engagé dans d'autres discussions ? À quel stade ? | |

**Minutes 20 à 28. Le candidat pose ses questions.**

Notez ce qu'il demande. C'est le premier indicateur exploitable du processus. Un candidat qui interroge sur les termes de l'association, sur l'origine des dossiers ou sur l'organisation du cabinet se projette. Un candidat qui interroge d'abord sur les congés et le télétravail se projette aussi, sur autre chose.

**Minutes 28 à 30. Vous concluez.**
...
Si le candidat déclare vouloir s'associer sans jamais avoir réfléchi aux conditions financières d'une association, ce n'est pas disqualifiant. C'est un sujet à travailler à l'étape 4.
...
Points à transmettre aux intervieweurs suivants :
_________________________________________________________________
_________________________________________________________________
...
|---|---|---|
| Reconstruit une chronologie exploitable à partir d'un dossier médical volumineux et lacunaire | Traite un dossier volumineux sans perdre d'élément important | Traite les pièces dans l'ordre où elles arrivent, sans hiérarchie |
| Repère la contradiction décisive entre deux avis techniques et en tire une stratégie | Croise méthodiquement pièces médicales et pièces juridiques | Ne repère pas les contradictions entre pièces |
| Sait ce qu'il ne sait pas et va chercher l'avis technique au bon moment | Identifie et réclame les pièces manquantes sans attendre | Se perd dans le détail et perd de vue l'enjeu du dossier |
| Distingue poste par poste ce qui se négocie de ce qui se plaide | Formule des hypothèses et les vérifie avant de conclure | Reporte les dossiers difficiles et traite d'abord les simples |
| Explique un dossier complexe en trois minutes à quelqu'un qui n'y connaît rien | Sait résumer un dossier par écrit de manière exploitable | Produit une analyse qui décrit le dossier sans le trancher |

### Questions

Posez l'une des quatre questions ci-dessous, puis approfondissez.

1. Parlez-moi du dossier le plus volumineux ou le plus technique que vous ayez eu à traiter. Comment vous y êtes-vous pris pour en prendre la mesure ?
2. Décrivez une situation où deux pièces ou deux avis techniques se contredisaient. Qu'avez-vous fait ?
3. Racontez-moi un dossier où votre analyse de départ s'est révélée fausse. Comment vous en êtes-vous aperçu, et ensuite ?
4. Parlez-moi d'un dossier que vous avez dû expliquer simplement à quelqu'un qui n'y comprenait rien. Comment avez-vous procédé ?
...
| Doué pour la compétence | Compétence maîtrisée | Compétence moins bien maîtrisée, posez des questions lorsque la personne |
|---|---|---|
| Adapte son rythme et son vocabulaire à l'état de la personne qu'il a en face | Répond aux sollicitations dans des délais courts | Parle en termes juridiques à un client qui ne les comprend pas |
| Annonce lui-même les mauvaises nouvelles, et vite | Explique la procédure et ses étapes avant qu'on ne les lui demande | Laisse le client sans nouvelles entre deux échéances |
| Tient le client informé sans attendre qu'il relance | Prépare le client avant une expertise ou une audience | Confond l'empathie et la promesse, laisse espérer ce qui n'arrivera pas |
| Distingue ce que le client demande de ce dont il a besoin, et le lui dit | Recueille les attentes et les intègre à la stratégie | Délègue systématiquement la relation difficile |
| Sait refuser une demande irréaliste sans abîmer la relation | Reste joignable et prévisible dans la durée | Parle de ses clients comme de dossiers |

### Questions

1. Parlez-moi d'un client avec lequel la relation a été difficile. Qu'avez-vous fait ?
2. Décrivez une fois où vous avez dû annoncer une mauvaise nouvelle à un client. Comment vous y êtes-vous pris ?
3. Racontez-moi une situation où ce que le client demandait n'était pas ce qui servait ses intérêts.
4. Parlez-moi d'un client que vous avez suivi plusieurs années. Comment avez-vous entretenu la relation dans la durée ?
...
Rappel : une note de 1 sur cette compétence arrête le processus.
...
| Doué pour la compétence | Compétence maîtrisée | Compétence moins bien maîtrisée, posez des questions lorsque la personne |
|---|---|---|
| Reprend un dossier après une décision défavorable et redéfinit une stratégie | Encaisse une décision défavorable et informe le client correctement | Se démobilise après un revers et laisse le dossier refroidir |
| Tient l'attention sur des procédures qui durent des années | Maintient la qualité de son travail sous pression | Diffère l'annonce d'une mauvaise nouvelle |
| Sépare l'échec de la procédure de la mise en cause personnelle | Reconnaît sa part dans un échec sans s'y enfermer | Attribue systématiquement les échecs à l'extérieur, juridiction, expert, adversaire |
| Sait où il dépose la charge émotionnelle, et le fait | Demande de l'aide quand la charge devient excessive | Évite les dossiers lourds émotionnellement |
| Reste opérationnel quand plusieurs dossiers vont mal en même temps | Distingue ce sur quoi il peut agir de ce qu'il subit | Confond l'engagement et l'absence de limites, et ne tient pas dans la durée |

### Questions

1. Parlez-moi de la décision judiciaire qui vous a le plus affecté. Que s'est-il passé ensuite ?
2. Décrivez une période où plusieurs dossiers ont mal tourné en même temps. Comment avez-vous tenu ?
3. Racontez-moi un dossier qui vous a coûté personnellement. Qu'est-ce qui vous a permis de continuer ?
4. Parlez-moi d'une fois où vous avez reconnu que vous étiez allé trop loin dans votre investissement sur un dossier.
...
Avertissement à l'intervieweur. Ces questions touchent à la vie personnelle du candidat. Vous cherchez le comportement professionnel, pas la confidence. Si le candidat aborde des éléments de santé ou de vie privée, ne les notez pas et ne les consignez pas. Ramenez l'échange sur ce qu'il a fait.
...
| Doué pour la compétence | Compétence maîtrisée | Compétence moins bien maîtrisée, posez des questions lorsque la personne |
|---|---|---|
| Contredit son associé ou sa hiérarchie quand l'analyse le justifie, et le documente | Exprime un désaccord quand on le lui demande | Laisse passer ce qu'il désapprouve pour éviter la tension |
| Dit à un client que sa demande est irréaliste, au risque de le perdre | Annonce les mauvaises nouvelles sans les différer | Attend d'avoir raison à coup sûr avant de parler |
| Refuse un dossier qu'il ne peut pas défendre correctement | Assume ses erreurs devant le client et devant l'équipe | Formule ses désaccords ailleurs que là où ils devraient être dits |
| Aborde un conflit interne rapidement plutôt que de le laisser s'installer | Pose les questions qui gênent en réunion | Cède devant un interlocuteur plus établi ou plus âgé |
| Prend position face à un expert reconnu, sur le fond, sans agressivité | Défend une position minoritaire avec des arguments | Présente ses réserves une fois la décision prise |

### Questions

1. Parlez-moi d'une fois où vous n'étiez pas d'accord avec votre associé ou votre employeur sur un dossier. Qu'avez-vous fait ?
2. Décrivez une situation où vous avez dû dire à un client quelque chose qu'il ne voulait pas entendre.
3. Racontez-moi une fois où vous avez refusé un dossier ou une mission. Pourquoi, et comment l'avez-vous dit ?
4. Parlez-moi d'une erreur que vous avez commise et de la façon dont vous l'avez annoncée.
...
| Doué pour la compétence | Compétence maîtrisée | Compétence moins bien maîtrisée, posez des questions lorsque la personne |
|---|---|---|
| A construit des relations de prescription qui produisent des dossiers, et sait les nommer | A déjà apporté des dossiers, même en nombre limité | N'a jamais réfléchi à l'origine de ses dossiers |
| Entretient son réseau sans attendre d'en avoir besoin | Entretient des relations avec des confrères, des médecins, des experts | Considère le développement comme le travail de l'associé |
| Est identifié dans sa matière par des confrères, des médecins, des associations | Participe aux événements de la profession | Confond le réseau et la présence sur les réseaux sociaux |
| Donne avant de demander | Sait recommander un confrère quand un dossier n'est pas pour lui | N'a aucune relation professionnelle en dehors de son cabinet actuel |
| Sait par quel chemin chaque dossier lui est arrivé | Connaît les acteurs de sa matière dans sa région | Ne cite aucun nom quand on lui demande qui compte dans sa matière |

### Questions

1. D'où viennent les dossiers sur lesquels vous travaillez ? Comment le savez-vous ?
2. Parlez-moi d'une relation professionnelle que vous avez construite et qui a produit quelque chose.
3. Décrivez ce que vous avez fait au cours des douze derniers mois pour être identifié dans votre matière.
4. Parlez-moi d'une fois où vous avez aidé un confrère ou un contact sans contrepartie immédiate. Qu'est-ce que cela a produit ensuite ?
...
Rappel : une note de 1 sur cette compétence arrête le processus. Un excellent technicien sans capacité de réseau ne devient pas associé, il reste collaborateur.
...
| Doué pour la compétence | Compétence maîtrisée | Compétence moins bien maîtrisée, posez des questions lorsque la personne |
|---|---|---|
| Formule une lecture de l'évolution de sa matière et en tire des conséquences concrètes | A des idées documentées sur ce que devrait faire son cabinet | Raisonne uniquement au dossier |
| A proposé à son cabinet une orientation qui a été suivie d'effet | Comprend le modèle économique de son activité | Ne connaît pas les chiffres de la structure où il exerce |
| Raisonne sur l'économie d'un cabinet, pas seulement sur ses propres dossiers | Se projette au-delà de l'année en cours | Confond la stratégie et l'intention, énonce des objectifs sans moyens |
| Anticipe l'effet d'une évolution législative ou jurisprudentielle sur l'activité | Identifie les menaces qui pèsent sur sa pratique | N'a jamais proposé d'orientation à personne |
| Distingue ce qui est urgent de ce qui est structurant, et protège le second | Sait renoncer à une opportunité qui disperse | Répond à la question de l'avenir en ne parlant que de sa propre carrière |

### Questions

1. Comment voyez-vous évoluer le droit du dommage corporel dans les cinq prochaines années ? Sur quoi fondez-vous cela ?
2. Parlez-moi d'une orientation que vous avez proposée à votre cabinet. Qu'en est-il advenu ?
3. Décrivez une décision où vous avez arbitré entre un gain immédiat et un intérêt de plus long terme.
4. Que savez-vous de l'économie du cabinet dans lequel vous exercez aujourd'hui, et comment l'avez-vous appris ?
...
Calibrage. À six ou dix ans d'exercice, vous cherchez l'amorce, pas la maturité. Un candidat qui connaît le chiffre d'affaires de son cabinet et sait comment il se forme est déjà au-dessus de la moyenne de sa génération.
...
Deux références minimum, avec l'accord écrit du candidat. Privilégiez un associé ou employeur précédent et un contact professionnel extérieur, confrère, expert ou magistrat.

N'interrogez jamais l'employeur actuel sans accord explicite et écrit.

## Questions

1. Dans quel cadre avez-vous travaillé ensemble, et sur quelle période ?
2. Quels types de dossiers lui confiiez-vous, et lesquels ne lui confiiez-vous pas ?
3. Comment se comportait-il avec les clients difficiles ?
4. Racontez-moi une fois où il vous a contredit.
5. Comment a-t-il réagi à un échec professionnel ?
6. Sur quoi avait-il besoin de progresser quand vous avez cessé de travailler ensemble ?
7. Le reprendriez-vous ? Sur quel poste ?

La question 4 est la plus discriminante. Si la personne interrogée ne trouve aucun exemple, c'est une information sur le candidat.
...
Réunion de décision avec tous les intervieweurs. Chacun arrive avec ses notes écrites.

Règle de conduite : chacun donne sa note et sa recommandation avant toute discussion. On discute ensuite. Une réunion qui commence par l'avis du plus ancien ne produit que son avis.
...
Décision :   proposition   /   deuxième candidat prioritaire   /   pas de suite

Si proposition, engagements pris auprès du candidat à formaliser par écrit :
_________________________________________________________________
_________________________________________________________________
